/**
 * Groth16 setup + Solidity verifier export for withdraw_1in_dev.
 */
...
async function main() {
  ...
  await snarkjs.zKey.contribute(
    ...
    "absolute-privacy-dev-entropy-1in"
  );
  ...
  source = source.replace(/contract Groth16Verifier/, "contract Withdraw1inDevVerifier");
