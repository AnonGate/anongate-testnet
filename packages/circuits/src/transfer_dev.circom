// Dev/compile-check circuit with smaller tree depth.
// Production target remains Transfer(20, 2, 2) in transfer.circom.
...
component main {public [merkleRoot, nullifiers, outCommitments, transferFee]} = Transfer(4, 2, 2);
